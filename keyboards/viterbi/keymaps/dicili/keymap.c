 ...
 * |------+-----------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Volu | Tab       |   Q  |   W  |   E  |   R  |   T  |      |   Y  |   U  |   I  |   O  |   P  | BSPC |   \  |
 * |------+-----------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Vold | Ctrl/Esc  |   A  |   S  |   D  |   F  |   G  |      |   H  |   J  |   K  |   L  |   ;  |   "  |Enter |
 * |------+-----------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Next | Shift     |   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  | Shift| Raise|
 * |------+-----------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 ...
 */
  ...
  //|-----+------+----+----+----+----+----|    |----+----+----+----+----+----+-----|
     VOLU ,TAB   , Q  , W  , E  , R  , T  ,      Y  , U  , I  , O  , P  ,BSPC,BSLS ,
  //|-----+------+----+----+----+----+----|    |----+----+----+----+----+----+-----|
     VOLD ,CTLESC, A  , S  , D  , F  , G  ,      H  , J  , K  , L  ,SCLN,QUOT,ENT  ,
  //|-----+------+----+----+----+----+----|    |----+----+----+----+----+----+-----|
     MNXT,LSFT   , Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH,RSFT,RASE ,
  //|-----+------+----+----+----+----+----|    |----+----+----+----+----+----+-----|
     MPLY,LCTL   ,LALT,LGUI,LOWR,SPC ,SPC ,     SPC , SPC,RASE,LEFT,DOWN, UP ,RGHT
  //`-----+------+----+----+----+----+----'    `----+----+----+----+----+----+-----'
  ),
